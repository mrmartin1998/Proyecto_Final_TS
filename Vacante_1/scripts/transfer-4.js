// non-validator-node-1 a validator-node
const { ethers } = require("hardhat");

async function main() {
    const privateKey = '0xe2c0aca545434ae69acb0e54c01b50d95bcf0ac0ab5e78301c886cfd5d2111b3'; // Clave privada de non-validator-node-1
    ...
    const transactionResponse = await contract.sendEther(
        receiverAddress,
        'Transfer 4: non-validator-node-1 to validator-node',
